            ...
            <div class="container-fluid">
                                        ...
                                        while ($row = mysqli_fetch_assoc($all_users)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="users.php?do=edit&edit_id=<?php echo $u_id;?>"data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">
                ...
                if($do == 'edit'){
                   ...
                   if(isset($_GET['edit_id'])){
                    ...
                    $uSql = "SELECT * FROM users WHERE u_id = '$user_id'";
                    $edituser = mysqli_query($db,$uSql);
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                           <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                <label for="exampleInputEmail" class="form-label">User Email*</label>
                                                <input type="email" class="form-control" id="exampleInputamail" aria-describedby="emailHelp" name="user_email" required="required" value="<?php echo $u_email;?>">
                                            </div>
                                            <div class="mb-3">
                                                <label for="exampleInputPassword" class="form-label">Password*</label>
                                        ...
                                        <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                     <label for="exampleInputEducation" class="form-label">Education</label>
                                                     <textarea rows="3" class="form-control" id="exampleInputEducation" name="user_education"><?php echo $u_education;?></textarea>
                                                </div>
                                                <div class="form-group">

                                                    <img src="image/users/<?php echo $u_image;?>" width ="120px">
                                                    <br><br>
                ...
                if($do == 'update'){
                    ...
                    if($_SERVER['REQUEST_METHOD'] == 'POST'){
                        ...
                        if(empty($user_password) && empty($image_name)){
                            ...
                            $updateSql = "UPDATE users SET u_name='$user_name', u_email='$user_email', u_address='$user_address', u_phone='$user_phone', u_dob='$user_dob', u_gender='$user_gender', u_bio='$user_biodata', u_education='$user_education', u_role='$user_role', u_status='$user_status' WHERE u_id = '$user_id'";
                            ...
                            if($updateresult){
                                    ...
                                    die("New User update error!".mysqli_error($db));
                            }
                        ...
                        if(in_array($extn, $extentions) === true){
                            ...
                            $updated_name = $random.$image_name;
                             ...
                             // find the file name
                             $image_name = "SELECT u_image from users WHERE u_id='$user_id'";
                        ...
                        $sql = "UPDATE users SET u_name='$user_name', u_image='$updated_name', u_email='$user_email', u_address='$user_address', u_phone='$user_phone', u_dob='$user_dob', u_gender='$user_gender', u_bio='$user_biodata', u_education='$user_education', u_role='$user_role', u_status='$user_status' WHERE u_id = '$user_id'";
                        ...
                        $encrypt_pass = sha1($user_password);
                        $sql = "UPDATE users SET u_name='$user_name', u_email='$user_email', u_password='$encrypt_pass', u_address='$user_address', u_phone='$user_phone', u_dob='$user_dob', u_gender='$user_gender', u_bio='$user_biodata', u_education='$user_education', u_role='$user_role', u_status='$user_status' WHERE u_id = '$user_id'";
                        $update_user = mysqli_query($db,$sql);
                        ...
                        $sql7 = "UPDATE users SET u_name='$user_name', u_image='$updated_name', u_email='$user_email', u_password='$encrypt_pass', u_address='$user_address', u_phone='$user_phone', u_dob='$user_dob', u_gender='$user_gender', u_bio='$user_biodata', u_education='$user_education', u_role='$user_role', u_status='$user_status' WHERE u_id = '$user_id'";
                        $update_user7 = mysqli_query($db,$sql7);
